...
<!-- Latest compiled and minified JavaScript -->
        ...
        $(document).ready(function (){
            $.ajax({
              ...
              trHTML +='<tr><td class="text-center">'+item.date_ts
                      ...
                      +'</td><td class="text-center"><a class="opt delete"></a> <a class="opt edit" onclick=\"form_dialog2(\'ADD TIMESHEET RECORD\', \'c_resource_timesheet/form_edit_timesheet/<?php echo $periode; ?>/'+item.date_ts+'/'+item.charge_code+'/'+item.employee_id+'\')"></a></td></tr>';
                        });
    ...
    <div class="search-fields bs-callout list-title">
        ...
        <div>
        <button class="btn btn-primary"  onclick="form_dialog2('ADD TIMESHEET RECORD', 'c_resource_timesheet/form_timesheet/<?php echo $periode; ?>');"><i class="fa fa-plus-square-o fa-lg"></i> Add Rows</button>
        </div>
...
<script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#form-timesheet').submit(function(){
                $('#table_timesheet tbody tr').
                $.ajax({
                    url:'<?php echo base_url(); ?>'+'c_resource_timesheet/upload_timesheet',
                    type:'POST',
                    dataType:'json',
                    data:$("#form-timesheet").serialize(),
                    success:function(data) {
         ...
         var formattedDate = curr_year + "-" + curr_month + "-" + curr_date;
          ...
          return;
            ...
            $('#upload_timesheet').submit(function(){
                $.ajax({
                    url:'<?php echo base_url(); ?>'+'c_rsc_timesheet/upload_timesheet',
                    type:'POST',
                    dataType:'json',
