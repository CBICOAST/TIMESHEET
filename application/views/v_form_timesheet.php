        ...
        <div class="requester-input form-section-container input-section new-employee-form" id="form-timesheet">
            <form method="post" id="form-timesheet">
                ...
                <div class="input-group">
                    ...
                    <input style="text-align: left; width: 175px;height: 100%;background:none;border: none;" value="" class="form-control holo" id="work" name="work">
                ...
                <div class="form-group">
                <label for="charge_code" class="col-sm-4 control-label">Charge Code</label>
                <div class="input-group">
                    <div class="input-group-addon">
                        <i class="fa fa-asterisk"></i>
                    </div>
                    <select name="charge_code"  data-placeholder="Choose Your Charge Code" id="charge" class="select_charge select_charge1 pull-right" style="width: 970px">
                                <option value=""></option>
