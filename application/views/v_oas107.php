...
<h1>Prosedur Pengajuan Purchase Request</h1>
<img src="<?php echo img_url(); ?>pr.png" style="max-height:500px">

<div>
	<input type="checkbox" id="ca-inform-setting"> Dont show this information again<br>
	<button onclick="inform_setting(); change_page(this, 'c_oas070/load_view')" style="margin:1px 0;padding:3px;text-align:center">Purchase Request</button>
</div>
...
<script type="text/javascript">
	function inform_setting () {
		if($('#ca-inform-setting').is(':checked')){
            ...
            $.ajax({
                url: "<?php echo site_url('c_oas107/dont_show_again'); ?>",
                type: 'POST',
                async : false,
                data: form_data,
